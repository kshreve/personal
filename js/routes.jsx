...
export default [
    <Route key="/" path="/" component={AppContainer}>
        ...
        <Route experiment="true" key="crankings" path="crankings" title="Combined Rankings" component={CrankingsContainer}/>
        <Route key="crankingsData" path="crankingsData" title="Create Data - Combined Rankings" component={CrankingsDataImportContainer}/>
        <Route experiment="true" key="whitelabel" path="whitelabel" title="White Labeling" component={WhiteLabelContainer}/>
        <Route experiment="true" key="xkcd1335" path="xkcd1335" title="XKCD - 1335" component={Xkcd}/>
