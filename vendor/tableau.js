                    ...
                    var check = function (target, type) {
                        if (type.__genericTypeDefinition === target.__genericTypeDefinition && type.__typeArguments.length == target.__typeArguments.length) {
                            for (var i = 0; i < target.__typeArguments.length; i++) {
                                ...
                                switch (v) {
                                    case 1:
                                        if (!ss.isAssignableFrom(t, s)) {
                                            return false;
                                        }
                                        break;
                                    case 2:
                                        if (!ss.isAssignableFrom(s, t)) {
                                            return false;
                                        }
                                        break;
                                    default:
...
// END CoreSlim
    ...
    (function () {
        ...
        ss.initEnum($tab_ApiErrorCode, $asm, {
        ...
        ss.initEnum($tab_ApiFieldAggregationType, $asm, {
            SUM:          'SUM',
            AVG:          'AVG',
            MIN:          'MIN',
            MAX:          'MAX',
